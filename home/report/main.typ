...
// и складывает рядом: ../1/scheme.png и т.д. Скриншоты терминала — в assets/.
...
#flow("/home/2/scheme-2.png", caption: [Блок-схема программы к заданию № 2 — лист 2; соединители «А» и «Б» связывают листы], width: 120mm)
